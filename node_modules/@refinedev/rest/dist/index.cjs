...
__export(src_exports, {
  authHeaderBeforeRequestHook: () => authHeaderBeforeRequestHook,
  createDataProvider: () => createDataProvider,
  refreshTokenAfterResponseHook: () => refreshTokenAfterResponseHook
});
...
var refreshTokenAfterResponseHook = (refineOptions) => async (request, _options, response) => {
  if (response.status === 401) {
    ...
    try {
      const data = await (0, import_ky.default)(
      ...
      return (0, import_ky.default)(request);
    } catch (e) {
      return response;
    }
  }
...
var createDataProvider = (apiURL, baseOptions = defaultCreateDataProviderOptions, kyOptions = {}) => {
  ...
  const ky2 = import_ky2.default.create({
    prefixUrl: apiURL,
    ...kyOptions,
    headers: {
  ...
  return {
    ...
    dataProvider: {
      ...
      custom: async (params) => {
        ...
        let client = import_ky2.default.create({
          method,
          ...kyOptions
        });
