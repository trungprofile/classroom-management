 ...
 * ```
 */
export declare const authHeaderBeforeRequestHook: (options: AuthHeaderBeforeRequestHookOptions) => NonNullable<Hooks["beforeRequest"]>[number];
export {};
//# sourceMappingURL=auth-header.before-request.hook.d.ts.map