...
var strapi_v4_exports = {};
__export(strapi_v4_exports, {
  createStrapiV4DataProvider: () => createStrapiV4DataProvider
});
module.exports = __toCommonJS(strapi_v4_exports);
...
//# sourceMappingURL=strapi-v4.cjs.map